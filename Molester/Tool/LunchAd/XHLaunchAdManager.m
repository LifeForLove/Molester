...
- (instancetype)init{
    ...
    if (self) {
        ...
        @weakify(self);
        [[MoNotificationCenter rac_addObserverForName:UIApplicationDidFinishLaunchingNotification object:nil]subscribeNext:^(id x) {
            @strongify(self);
            //初始化开屏广告
...
-(void)example01{
    ...
    imageAdconfiguration.imageNameOrURLString = @"http://yun.it7090.com/image/XHLaunchAd/pic02.jpg";
    ...
    //    if([XHLaunchAd checkImageInCacheWithURL:[NSURL URLWithString:@"http://yun.it7090.com/image/XHLaunchAd/pic02.jpg"]]){
    //        //设置要添加的自定义视图(可选)
